...
function HRPCard() {
  return (
    <>
        <div className='m-4 hover:bg-slate-200 hover:scale-105 hover: transition ease-out hover:rounded-md active:translate-y-1 active:scale-100 active:btn-primary '>
